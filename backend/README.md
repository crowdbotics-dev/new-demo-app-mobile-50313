...
## Project Structure
    ...
    ├── new_demo_app_mobile_50313  # Django project configurations
...
1. Clone this repo and `cd new_demo_app_mobile_50313`
...
2. Clone this repo and `cd new_demo_app_mobile_50313`
